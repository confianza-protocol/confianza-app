            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                  ...
                  <span className="block text-blue-600 xl:inline">trading for LATAM</span>
                </h1>
                ...
                {/* Trust Score Preview */}
                <div className="mt-8 bg-gray-50 rounded-lg p-6 max-w-md">
                  <h3 className="text-lg font-medium text-gray-900 mb-4">Trust Score System</h3>
          ...
          <div className="mt-10">
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
              <div className="text-center">
                ...
                <h3 className="mt-4 text-lg leading-6 font-medium text-gray-900">On-Chain Reputation</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="mt-4 text-lg leading-6 font-medium text-gray-900">Secure Escrow</h3>
                <p className="mt-2 text-base text-gray-500">
              ...
              <div className="text-center">
                ...
                <h3 className="mt-4 text-lg leading-6 font-medium text-gray-900">Community Driven</h3>
                <p className="mt-2 text-base text-gray-500">
